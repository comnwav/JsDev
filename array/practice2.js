...
let result = objAry.reduce(function (accu, e, ind) {
    accu += `<li>${e['id']}, first_name: ${e['first_name']}</li>`;
...
let testAry = [32, 342, 34, 23, 98, 32, 123,];

let max = testAry.reduce(function (accu, e) {
    return accu > e ? accu : e;
});
document.write(max);